...
const messages = {
  ja: {
    ...
    build: {
      ...
      scoreEach: "各項目: max(重み付き合計, 会心合計)",
      weighted: "重み付き合計:",
      scoreAttack: "(攻撃力x0.1 + 攻撃力%) / 2",
  ...
  en: {
    ...
    build: {
      ...
      scoreEach: "Each item: max(weighted total, crit total)",
      weighted: "Weighted total:",
      scoreAttack: "(ATK x0.1 + ATK%) / 2",
  ...
  zhHans: {
    ...
    build: {
      ...
      scoreEach: "每项: max(加权合计, 暴击合计)",
      weighted: "加权合计:",
      scoreAttack: "(攻击力x0.1 + 攻击力%) / 2",
